glabel func_802D67A8_31A8F8
    ...
    /* 31A8FC 802D67AC 3C0F802E */  lui        $t7, %hi(D_802E4F88_3290D8)
    ...
    /* 31A914 802D67C4 25EF4F88 */  addiu      $t7, $t7, %lo(D_802E4F88_3290D8)
  ...
  .L802D69EC_31AB3C:
    ...
    /* 31AB50 802D6A00 3C01802E */  lui        $at, %hi(jtbl_802E7B08_32BC58)
    /* 31AB54 802D6A04 002A0821 */  addu       $at, $at, $t2
    /* 31AB58 802D6A08 8C2A7B08 */  lw         $t2, %lo(jtbl_802E7B08_32BC58)($at)
  ...
  .L802D6A30_31AB80:
    ...
    /* 31ABB8 802D6A68 3C04802E */  lui        $a0, %hi(D_802E7AA4_32BBF4)
    /* 31ABBC 802D6A6C A2220000 */  sb         $v0, 0x0($s1)
    /* 31ABC0 802D6A70 24847AA4 */  addiu      $a0, $a0, %lo(D_802E7AA4_32BBF4)
    ...
    /* 31ACD0 802D6B80 3C01802E */  lui        $at, %hi(D_802E7B24_32BC74)
    /* 31ACD4 802D6B84 C4207B24 */  lwc1       $f0, %lo(D_802E7B24_32BC74)($at)
  ...
  .L802D6D90_31AEE0:
    ...
    /* 31AEFC 802D6DAC 3C01802E */   lui       $at, %hi(D_802E7B28_32BC78)
  .L802D6DB0_31AF00:
  ...
  .L802D6DC0_31AF10:
    /* 31AF10 802D6DC0 D4307B28 */  ldc1       $f16, %lo(D_802E7B28_32BC78)($at)
  ...
  .L802D71E0_31B330:
    ...
    /* 31B3BC 802D726C 3C0B8014 */  lui        $t3, %hi(D_8013FD78_14ED28)
    /* 31B3C0 802D7270 8D6BFD78 */  lw         $t3, %lo(D_8013FD78_14ED28)($t3)
