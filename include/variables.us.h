...
extern u16 D_80257A3A[]; // = vehicleSpecs[0].hitPoints (u16 max HP table, stride 112)

extern BuildingSpec buildingSpecs[0x20]; // 0x80259090
extern u8 D_802590A4[];
extern u8 D_802590A8[];
extern s8 D_802590A9[]; // = buildingSpecs[0].pad16[3] (s8 max HP table, stride 32)
...
extern u16 D_802566BA[]; // = alienSpecs[0].pad3A (u16 max HP table, stride 104)
