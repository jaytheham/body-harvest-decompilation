...
You will then orchestrate processing of these functions one at a time. For each function, you will create a new subagent, it must use agentName `Body Harvest Decomp`, and use it to decompile a single function.
