...
5. Add definitions for these variables in the appropriate C file, make sure to use the correct types, order, and initial values as in the original ROM. Define the variables before the first function in the C file.
