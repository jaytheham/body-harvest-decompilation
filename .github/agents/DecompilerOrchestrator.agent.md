...
6. If the build fails, create a new subagent with agentName `BH Match Improver` to try to finish the matching decompilation and achieve a successful build.
