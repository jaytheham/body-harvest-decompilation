...
void func_8008D040_9BFF0(u8 arg0)
{
	...
	if ((parentUnk20 & 0x1000) && (inst->unk20 & 0xF000))
	{
		...
		do
		{
			osSyncPrintf(&D_80141E80_150E30, *((s32 *)(&alienSpecs[inst->specIndex].unk18)), parent, parentUnk20);
		} while (0);
	}
}
...
void func_8008D4A0_9C450(unsigned int arg0)
{
	...
	if ((target == 0x100) ||
		((target != 0xFF) && ((!(alienInstances[target].unk20 & 0x40000000)) || (!(alienInstances[target].unk20 & 0x600)))))
	{
...
void func_8008E978_9D928(u8 arg0, s32 arg1)
{
	...
	alienInstances[arg0].unkA = (s16)((s32)((alienInstances[arg0].unkA) * D_80141EE0_150E90[0]));
	...
	alienInstances[arg0].unk10 = (s16)(-((s32)(((((f32)sins(alienInstances[arg0].unkA))) / 32768.0) * ((f64)sp2C))));
}
#else
...
void func_80091E70_A0E20(u8 arg0)
{
  ...
  targetSpeed = alienSpecs[specIndex].unk40;
  ...
  {
	alienInstances[arg0].unk12 += alienSpecs[specIndex].unk3E * 4;
  }
...
void func_80092EF4_A1EA4(u8 arg0)
{
  ...
  if (alienInstances[arg0].unk20 & 0x1000)
  {
	...
	if ((new_var & 0xE) || ((alienInstances[arg0].unk2 - alienSpecs[sp3F].unkC) < sp38))
	{
...
void func_80094BE0_A3B90(u8 arg0)
{
	...
	if ((func_80085E2C_94DDC(arg0, sp37, 0x4000) == 0) && (alienInstances[arg0].unk1E == 0))
	{
		...
		alienSpecs[specIndex].unk20 = ((((f32)sins(D_8014DD50[sp37].unk6))) / 32768.0) * 50.0;
		alienSpecs[specIndex].unk24 = ((((f32)coss(D_8014DD50[sp37].unk6))) / 32768.0) * 50.0;
