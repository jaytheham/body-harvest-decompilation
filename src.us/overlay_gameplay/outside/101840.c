...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/overlay_gameplay/outside/101840/func_800F2890_101840.s")
#endif
...
void func_800F3038_101FE8(u8 arg0) {
	...
	if (arg0 >= 9) {
		osSyncPrintf(D_80144768_153718, (u8)arg0);
	}
	if (D_80157FF0[arg0] != -1) {
		osSyncPrintf(D_80144780_153730, (u8)arg0);
	}

	count = ((u8*)D_801601F0)[D_80158000[arg0 * 0x170 + 0x23] * 0x16 + 0xC];
	...
	*(s16 *)&D_80158000[arg0 * 0x170 + 0x16A] = 0;
	if (*(s16 *)((u8*)D_801601F0 + D_80158000[arg0 * 0x170 + 0x23] * 0x16 + 0xA) >= 0x64) {
...
void func_800F34AC_10245C(s32 arg0) {
	...
	D_80158000[temp * 0x170 + 0x22] = 0x10;
	*(s32*)&D_80158000[temp * 0x170] = *(s32*)&D_80158000[temp * 0x170 + 0x10];
	*(s32*)&D_80158000[temp * 0x170 + 4] = *(s32*)&D_80158000[temp * 0x170 + 0x14];
	*(s16*)&D_80158000[temp * 0x170 + 0x16A] = *(s16*)&D_8014DD52[alienInstances[D_80158000[temp * 0x170 + 0x144]].unkC * 0x10] + alienInstances[D_80158000[temp * 0x170 + 0x144]].unk2;
}
#else
...
s16 func_800F384C_1027FC(UnkF9230Arg0 *arg0, s16 arg1, s16 arg2, s16 arg3) {
	...
	sp36_s32 = *(s16 *)((u8 *)D_802566D8 + D_800481B2[arg0->unk144 * 0x50] * 0x68);
	...
	sp36_s32 = sp36;
	if ((f32)sp36_s32 < (f32)arg1 - (f32)*(s16 *)((u8 *)D_802566D8 + D_800481B2[arg0->unk144 * 0x50] * 0x68) * var_f2) {
		sp36_s32 = (s16)((f32)arg1 - (f32)*(s16 *)((u8 *)D_802566D8 + D_800481B2[arg0->unk144 * 0x50] * 0x68) * var_f2);
	} else if ((f32)arg1 - (f32)*(s16 *)((u8 *)D_802566D8 + D_800481B2[arg0->unk144 * 0x50] * 0x68) * var_f2 < (f32)sp36_s32) {
		sp36_s32 = (s16)((f32)arg1 + (f32)*(s16 *)((u8 *)D_802566D8 + D_800481B2[arg0->unk144 * 0x50] * 0x68) * var_f2);
	}
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/overlay_gameplay/outside/101840/func_800F9E0C_108DBC.s")
#endif
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/overlay_gameplay/outside/101840/func_80102DDC_111D8C.s")
#endif
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/overlay_gameplay/outside/101840/func_80115730_1246E0.s")
#endif
