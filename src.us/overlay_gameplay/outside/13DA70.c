...
void func_801306C4_13F674(u8 *arg0)
{
  ...
  char *new_var;
  u32 temp;
  if (D_80140C84_14FC34)
  {
	D_80140C84_W = 0;
	D_80052B2C->unk30 = D_80052B2C->unk30 + 0x2710;
	D_80140C88_14FC38 = 0;
	D_80140C8C_14FC3C = 0;
	D_80140C90_14FC40 = 0;
	D_80140C94_14FC44 = 0;
  ...
  else
  {
	...
	switch (D_800313D0_31FD0)
	{
	  ...
	  case 2:
		new_var = D_801454E0_154490;
		func_8012F4E0_13E490(new_var, 0x12, 0x18, 0x82, D_80140C70_14FC20, 0, 0, 0);
		break;
  ...
  if (((currentControllerStates[0].button & 0xD000) != 0) && (D_80140C88_14FC38 == 0))
  {
	...
	{
	  D_80140CA0_14FC50 = temp;
	  D_80140C9C_14FC4C = temp;
	  D_80140C98_14FC48 = temp;
	  D_80140C94_14FC44 = 0;
	  D_80140C90_14FC40 = 0;
	  D_80140C8C_14FC3C = 0;
	...
	{
	  D_80140C88_14FC38 = temp;
	  D_80140C98_14FC48 = 0;
	}
  }
  if ((D_80140C88_14FC38 != 0) && (D_80140C98_14FC48 != 0))
  {
	D_80140C84_14FC34 = temp;
	if (D_8015FF80 == 5)
	{
	  D_8015FF80 = 6;
	  return;
...
void func_80130BA0_13FB50(void)
{
	...
	if ((D_80160070 == D_80052B2C->unk30) && (D_8016006C == 0x1E)) {
		D_8016006C = 0;
		D_8016006D = 0;
		if (D_80160058 + 1 < 4) {
	...
	if (D_80160070 == baseScore) {
		baseScore = D_8016006C + 1;
		if (baseScore < 0x1E) {
			D_8016006C = baseScore;
		} else {
			D_8016006C = 0x1E;
		}
	} else {
		if (D_80160070 < baseScore + 0x64) {
			D_80052B2C->unk30 = D_80160070;
		} else {
			D_80052B2C->unk30 = baseScore + 0x64;
		}
		func_800153D8_15FD8(0xCD);
		D_8016006C = 0;
	}
	...
	if (D_80160058 > 0) {
		if (D_80160058 == 1) {
			...
			if (D_8016006D < 0x15) {
				drawText(D_80145500_1544B0, D_8016006D * 12, ++D_8016006D);
			} else {
				drawText(D_80145504_1544B4, 0xFF, D_8016006D);
			}
		}
		switch (D_800313D0_31FD0) {
		case 0:
	...
	if (D_80160058 >= 2) {
		if (D_80160058 == 2) {
			...
			if (D_8016006D < 0x15) {
				drawText(D_80145550_154500, D_8016006D * 12, ++D_8016006D);
			} else {
				drawText(D_80145554_154504, 0xFF, D_8016006D);
			}
		}
		switch (D_800313D0_31FD0) {
		case 0:
...
void func_80131280_140230(u8 *arg0)
{
	...
	if (D_80140CB4_14FC64 != 0) {
		...
		D_80140CCC_14FC7C = 0;
		D_80140CD0_14FC80 = 0;
		D_80140CDC_W_RESET = 0x82;
	}

	if ((D_80140CDC_14FC8C >= 0x6F) && (D_80140CC0_14FC70 != 0)) {
		D_80140CDC_W_DEC = D_80140CDC_14FC8C - 2;
	}
	...
	if (isButtonNewlyPressed(CONTROLLER_ONE, BUTTON_START | BUTTON_Z | BUTTON_A) != 0) {
		if ((D_80140CC0_14FC70 == 0) || (D_80140CC8_14FC78 == 0) || (D_80140CDC_14FC8C >= 0x6F) || (D_80140CD4_14FC84 == 0)) {
			D_80140CC0_14FC70 = 1;
			D_80140CBC_14FC6C = 0;
			D_80140CC8_W_BUTTON = 1;
			D_80140CC4_14FC74 = 0;
			D_80140CDC_14FC8C = 0x6E;
			D_80140CD4_W_BUTTON = 1;
		} else {
			D_80140CB8_W = 1;
			D_80140CBC_W = 0;
			D_80140CC0_W = 0;
