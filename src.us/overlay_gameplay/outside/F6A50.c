...
s16 D_8013B8F8_14A8A8 = 0x1F4;
s16 D_8013B8FC_14A8AC = 0x40;

s16 D_8013B900_14A8B0 = 0x40;
s16 D_8013B904_14A8B4 = 0x0;
s8 D_8013B908_14A8B8 = 0;
s8 D_8013B90C_14A8BC = 0;

s16 D_8013B910_14A8C0[6] = {0x0000, 0x012C, 0x012C, 0x05DC, 0x0000, 0x03E8};
s16 D_8013B91C_14A8CC[6] = {0x0000, 0x000A, 0x0032, 0x001E, 0x0000, 0x000A};

s16 D_8013B928_14A8D8[6] = {0x05AA, 0x0578, 0x041A, 0x041A, 0x0000, 0x041A};

s16 D_8013B934_14A8E4 = 0x05DC;
...
void func_800E7B20_F6AD0(s32 arg0, s32 arg1) {
	...
	D_8013FD7C_14ED2C = arg1;
	D_801493D8 = (s16)arg1;
	D_8013B934_14A8E4 = D_8013B910_14A8C0[arg1];
	temp = (D_8013B91C_14A8CC[arg1] << 16) / 360;
	if (D_8013B8F0 < temp) {
		D_8013B8F0 = (s16)temp;
	}
	D_801493A8 = D_8013B928_14A8D8[arg1];
	D_801493AA = (s16)temp;
	if (D_801591BC != 0) {
		D_801493AA = 0x2260;
	}
...
void func_800E7C28_F6BD8(void)
{
  ...
  if (!(currentControllerStates[1].button & 0x20))
  {
	if (D_80157590 == 4)
	{
	  ...
	  D_80157580 = (((((((f32) coss(D_8015758E))) / 32768.0) * (((((f32) sp32)) / 32768.0) * (D_8013E438))) + (D_80157586)));
	  D_80157582 = (((((((f32) sins(D_8015758C))) / 32768.0) * (D_8013E438)) + (D_80157588)));
	  if (currentControllerStates)
	  {
	  }
	  sp32 = coss((u16) D_8015758C);
	  D_80157584 = (((((((f32) sins(D_8015758E))) / 32768.0) * (((((f32) sp32)) / 32768.0) * (D_8013E438))) + (D_8015758A)));
	  return;
	}
	...
	sp32 = coss((u16) D_8015758C);
	D_80157586 = ((D_80157580 - (((((f32) coss(D_8015758E))) / 32768.0) * (((((f32) sp32)) / 32768.0) * D_80144240))));
	D_80157588 = (((D_80157582) - (((((f32) sins(D_8015758C))) / 32768.0) * D_80144248)));
	sp32 = coss(D_8015758C);
	D_8015758A = (((D_80157584) - (((((f32) sins(D_8015758E))) / 32768.0) * (((((f32) sp32)) / 32768.0) * D_80144250))));
...
void func_800E8190_F7140(void) {
	...
	D_8013B91C_14A8CC[0] = 0;
	D_8013B91C_14A8CC[1] = 0xA;
	D_8013B91C_14A8CC[2] = 0x32;
	D_8013B91C_14A8CC[3] = 0x1E;
	D_8013B91C_14A8CC[4] = 0;
	D_8013B91C_14A8CC[5] = 0xA;
	D_8013B928_14A8D8[0] = 0x578;
	D_8013B928_14A8D8[1] = 0x514;
	D_8013B928_14A8D8[2] = 0x41A;
	D_8013B928_14A8D8[3] = 0x41A;
	D_8013B928_14A8D8[4] = 0;
	D_8013B928_14A8D8[5] = 0x41A;
	D_8013B910_14A8C0[0] = 0;
	D_8013B910_14A8C0[1] = 0x12C;
	D_8013B910_14A8C0[2] = 0x12C;
	D_8013B910_14A8C0[3] = 0x5DC;
	D_8013B910_14A8C0[4] = 0;
	D_8013B910_14A8C0[5] = 0x3E8;
	D_801493DC = 0;
	D_8014940E = 0;
	if (D_80052B34->unk1A == 0) {
	...
	D_80157576 = 0x500;
	D_8013B90C_14A8BC = 0;
	D_8013B8F4_14A8A4 = 0x1F4;
	D_8013B8FC_14A8AC = 0x40;
	D_8013B8F8_14A8A8 = 0x1F4;
	D_8013B900_14A8B0 = 0x40;
	D_8013B908_14A8B8 = 0;
}
