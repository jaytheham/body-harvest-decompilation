...
u8 D_8013DCF0_14CCA0[0x28] = {
	0x05, 0x05, 0x9C, 0xA0, 0x05, 0x05, 0x8A, 0xA0, 0x05, 0x05, 0x8C, 0xA0, 0x05, 0x05, 0x8E, 0xA0,
	0x05, 0x05, 0x90, 0xA0, 0x05, 0x05, 0x92, 0xA0, 0x05, 0x05, 0x94, 0xA0, 0x05, 0x05, 0x96, 0xA0,
	0x05, 0x05, 0x98, 0xA0, 0x05, 0x05, 0x9A, 0xA0,
};
...
#ifdef NON_MATCHING
void func_800CD0B0_DC060(s32 arg0) {
	s16 srcIdx;
	s32 pad1;
	s16 dstIdx;
	u8 idx;
	...
	idx = arg0 & 0xFF;
	srcIdx = D_80154088[idx].unk6;
	dstIdx = func_800C17B4_D0764(idx, 0);
	if (dstIdx != -3) {
		dst = &D_80154318[dstIdx];
		dst->unk2 = (func_800038E0_44E0() % 40) + 20;
		dst->unkE = 0xFF;
		dst->unkF = 0xFF;
		dst->unk10 = 0xFF;
		dst->unk11 = 0xFF;
		src = &D_80154318[srcIdx];
		dst->unk8 = src->unk8;
		dst->unkA = src->unkA;
		dst->unkC = src->unkC;
		((s8 *)&dst->unk12)[0] = ((s8 *)src)[0xE] + (func_800038E0_44E0() % 6) - 3;
		((s8 *)&dst->unk12)[1] = ((s8 *)src)[0xF] + (func_800038E0_44E0() % 6) - 3;
		dst->unk14 = ((s8 *)src)[0x10] + (func_800038E0_44E0() % 6) - 3;
		dst->unk15 = 0;
	}
}
#else
