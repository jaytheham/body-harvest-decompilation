...
void func_8007E608_8D5B8(AlienInstance *arg0, AlienInstance *arg1) {
	...
	specA = arg0->specIndex;
	sp24 = &alienSpecs[specA];
	if (arg1->unkD == -2) {
		var_a3 = (AlienSpec *)&vehicleSpecs[arg1->specIndex];
	} else {
		var_a3 = &alienSpecs[arg1->specIndex];
	}
	sp1C = sp24->unk8;
	sp18 = var_a3->unk8;
	if (arg1->unkD != -2) {
	...
	func_8007E500_8D4B0(arg0, sp24, arg1, var_a3);
	sp24->unk8 = sp1C;
	var_a3->unk8 = sp18;
}
#else
...
void func_80088E40_97DF0(u8 arg0, s16 arg1, s16 arg2, s16 arg3, s16 arg4, s8 arg5, s8 arg6, s8 arg7) {
	...
	alien = &alienInstances[arg0];
	func_80128428_1373D8((Unk80128428Arg0 *)alien, arg2, arg3, arg4, &sp34, &sp30, &sp2C);
	func_800DF848_EE7F8((s16)sp34, (s16)sp30, (s16)sp2C, 0x50, 0);
	sp3A = func_800C7924_D68D4((s16)sp34, (s16)sp30, (s16)sp2C, 0x40, -8,
							  alienSpecs[alien->specIndex].unkC,
							  func_8008916C_9811C(arg0, arg1), 1);
	func_800C80F0_D70A0((0x4000 - alien->unk6) & 0xFFFF, 0, 0, sp3A);
...
void func_80090948_9F8F8(s16 arg0, u16 arg1) {
	...
	if (D_8014DD5E[arg0][0] == 0) {
		sp20.unk6 = (s32)(func_800038E0_44E0() * (u16)arg1) / 0x10000 - arg1/2;
		sp20.unk8 = (s32)(func_800038E0_44E0() * (u16)arg1) / 0x10000 - arg1/2;
		sp20.unkA = (s32)(func_800038E0_44E0() * (u16)arg1) / 0x10000 - arg1/2;
