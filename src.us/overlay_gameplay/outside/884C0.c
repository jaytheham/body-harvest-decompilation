...
s32 func_80085838_947E8(u8 arg0)
{
  ...
  neg_dx = -dx;
  if (neg_dx < dx) abs_dx = dx;
  else             abs_dx = neg_dx;
  
  neg_dz = -dz;
  if (neg_dz < dz) abs_dz = dz;
  else             abs_dz = neg_dz;    
  
  if (abs_dz < abs_dx)// a1 < v1
  {
	  // abs_dx=neg_dx;
	if (neg_dx < dx)//a3 < v0
	{
  ...
  {
	if (abs_dx = neg_dz, neg_dz < dz)// a0 < a2
	{
	  abs_dx = dz;     
	} else {
	  max = neg_dz;
