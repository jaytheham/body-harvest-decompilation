...
s32 func_8007A2A0_89250(s32 arg0)
{
  ...
  {
	s8 slot = (s8)func_800F3990_102940((u8)arg0, (u8)alienSpecs[sp34].unk50);
	if (slot == (-1))
	{
...
void func_8007B370_8A320(s32 arg0) {
	...
	sp88 = arg0;
	temp_t3 = &alienInstances[arg0 & 0xFF];
	temp_v0 = temp_t3->unk48;
	if (temp_v0 < 0xF) {
		var_f0 = (f32)((f64)(f32)sins((u32)((f32)(temp_v0 << 0xE) / 15.0f) & 0xFFFF) / 32768.0);
	} else {
		var_f0 = (f32)((f64)(f32)sins((u32)((f32)((temp_v0 * -0x4000) + 0x50000) / 5.0f) & 0xFFFF) / 32768.0);
	}
	temp_v0_2 = temp_t3->specIndex;
	var_t4 = ((s16 *)&D_8025668C)[temp_v0_2 * 0x34];
	if (temp_v0_2 == 0x1A) {
		var_t4 = (s16)(s32)((f64)var_t4 * 1.5);
	}
	sp80 = var_t4 * 0xA;
	temp_f16 = (s32)((f32)sp80 * var_f0);
	sp80 = (s16)temp_f16;
	sp82 = (s16)((s16)temp_f16 / 2);
	sp84 = (s16)temp_f16;
	sp78 = (s16)((s16)temp_t3->unk0 / 4);
	sp7A = (s16)((s16)temp_t3->unk2 / 4);
	sp7C = (s16)((s16)temp_t3->unk4 / 4);
	...
	temp_v0_15 = D_8005BB2C;
	temp_v0_15->words.w1 = (u32)&D_80031200;
	temp_v0_15->words.w0 = 0x06000000;
	temp_v0_15 = D_8005BB2C;
	temp_v0_15->words.w1 = 0xFFFE7838;
	temp_v0_15->words.w0 = 0xFCFFFFFF;
	temp_v0_15 = D_8005BB2C;
	temp_v0_15->words.w1 = 0x00008000;
	temp_v0_15->words.w0 = 0xBA000E02;
	temp_v0_15 = D_8005BB2C;
	temp_v0_15->words.w1 = 0;
...
void func_8007B9CC_8A97C(s32 arg0) {
	...
	if (sp5C != -1) {
		...
		dl->words.w1 = osVirtualToPhysical((void *)(D_8005BB38 + 0x40));
	}
	...
	do {
		...
		if (specIndex != 0) {
			...
			if (!(flags & 0x600)) {
				...
				spec = (AlienSpec *)((u8 *)specBase + (specIndex * specStride));
...
s32 func_8007EB74_8DB24(AlienInstance *arg0, AlienInstance *arg1) {
	...
	if (((s8 *)arg0)[0xD] != -2) {
		...
		if (specIndex != 0x1B) {
			...
			if (*(s32 *)((u8 *)D_802566D4 + (specIndex * 0x68)) & 1) {
				signB = 1;
				signA = 1;
...
void func_800800E4_8F094(u8 arg0)
{
	...
	if (func_80080418_8F3C8(arg0, sp3C, sp38) != 0) {
		...
		if (temp_v0 & 0x80000) {
			...
			inst->unk20 = (s32) (inst->unk20 | func_800F3990_102940(arg0, D_802566D0[inst->specIndex * 0x68]));
		}
	}
	if ((D_802566D4[inst->specIndex * 0x1A] & 0x841) || (inst->unk20 & 0x60000000)) {
...
s32 func_8008751C_964CC(u8 arg0, s32 arg1, s32 arg2)
{
	...
	tempV1 = (s16)tempV1;
	specVal = D_802566C0[specIndex * 0x34];
...
void func_80089FAC_98F5C(u8 arg0) {
	...
	if (!(alien->unk20 & 0x100000)) {
		...
		if (alien->unk20 & 0x600) {
			...
			alienSpec = &alienSpecs[specIndex];
			func_800DF848_EE7F8(alien->unk0, alien->unk2, alien->unk4, (u16)(alienSpec->unkC * 2), 0);
			if (!(alien->unk20 & 0x1000)) {
				alien->unk38 = func_800C3BD8_D2B88(
					alien->unk0,
					alien->unk2 + 0x1E,
					alien->unk4,
					(u16)((f64)alienSpec->unkC * 1.5),
					0x3C,
					0xF0,
					0x78,
					0);
		...
		if (alien->unk2C >= 0x1F) {
			...
			if (alien->unk2C == 1) {
				alien->unk38 = -1;
				if (alien->unk20 & 0x600) {
					func_800DF848_EE7F8(alien->unk0, alien->unk2, alien->unk4, ((u16 *)&D_8025668C)[specIndex * 0x34], 2);
				}
			}
		}
	}

	if ((alien->unk2C == 1) && (D_80031420 & 3)) {
		func_800CA5EC_D959C(
			alien->unk0,
			alien->unk2,
			alien->unk4,
	...
	if (alien->unk38 != -3) {
		func_800C3D88_D2D38(alien->unk0, alien->unk2 + 0x1E, alien->unk4, alien->unk38);
	}
...
void func_8008A3EC_9939C(u8 arg0) {
	...
	if (alien->unk2C == 0x10) {
		if (alien->unk20 & 0x600) {
			baseRadius = ((s16 *)&D_8025668C)[alien->specIndex * 0x34];
			...
			for (i = 0; i < alien->unk24; i++) {
				func_800C7924_D68D4(
					...
					0x10,
					effectId,
					(u32)((f64)((s16 *)&D_8025668C)[alien->specIndex * 0x34] * 1.5),
					&D_502D390,
					1);
			}
		}
		...
		if (alien->unk20 & 0x600) {
			func_800DF848_EE7F8(alien->unk0, alien->unk2, alien->unk4, ((u16 *)&D_8025668C)[alien->specIndex * 0x34], 6);
			if (alien->unk20 & 0x80000) {
				func_800F3038_101FE8(alien->unk20 & 7);
				alien->unk20 &= ~0x80000;
			}
...
void func_8008B8E4_9A894(u8 arg0)
{
	...
	nodes[0] = D_8014DD50[inst->unkC].unkC;
	if (nodes[0] != -1) {
		flags = inst->unk20;
	...
	waitCounter = inst->unk3A;
	if (waitCounter != 0) {
		inst->unk3A = waitCounter - 1;
	} else {
		timer = inst->unk2C;
		if (timer >= 0x3F) {
			delay = 3;
			...
			inst->unk3A = func_800038E0_44E0(delay) % delay;
			effectType = func_800038E0_44E0() % 3;
			rand[0] = func_800038E0_44E0();
			rand[1] = func_800038E0_44E0();
			rand[2] = func_800038E0_44E0();
			func_800DFA34_EE9E4(
				(s16)((inst->unk0 - ((u16)rand[0] % 0x190)) + 0xC8),
				(s16)(((u16)rand[1] % 0xFA) + inst->unk2),
				(s16)((inst->unk4 - ((u16)rand[2] % 0x190)) + 0xC8),
				(u16)((func_800038E0_44E0() % 0x46) + 0x32),
				effectType);
		}
	}

	if ((inst->unk2C == 0x34) || (inst->unk2C == 0x33)) {
		func_800E35E0_F2590(0x80);
	}

	if ((inst->unk2C == 0x34) || (inst->unk2C == 0xF)) {
		func_800DF848_EE7F8(inst->unk0, (s16)(inst->unk2 + 0x1E), inst->unk4, 0x1F4, 0xA);
	}
...
void func_8008C428_9B3D8(s32 arg0) {
	...
	inst = &alienInstances[arg0];
	inst->unk20 |= 0x40000000;
	temp_s2 = inst->unk6 & 0xFFFF;
	sp56 = inst->unk0;
	sp54 = inst->unk4;
	inst->unk10 = 0x300;
	inst->unk20 &= 0xFFF7FFFF;
	temp_s1 = coss(temp_s2 & 0xFFFF);
	temp_f24 = (f64)sp56;
	temp_f26 = (f64)sp54;
	sp4C = func_800B84D0_C7480(
		(s16)(s32)((((f64)(f32)temp_s1 / 32768.0) * 25.0) + temp_f24),
		(s16)(s32)((((f64)(f32)sins(temp_s2 & 0xFFFF) / 32768.0) * 25.0) + temp_f26)
	) >> 8;
	temp_s1 = coss(temp_s2 & 0xFFFF);
	inst->unk14 = func_80003824_4424(
		50.0f,
		(f32)(sp4C - (func_800B84D0_C7480(
			(s16)(s32)(temp_f24 - (((f64)(f32)temp_s1 / 32768.0) * 25.0)),
			(s16)(s32)(temp_f26 - (((f64)(f32)sins(temp_s2 & 0xFFFF) / 32768.0) * 25.0))
		) >> 8))
	);
	temp_s1 = sins(temp_s2 & 0xFFFF);
	sp4C = func_800B84D0_C7480(
		(s16)(s32)((((f64)(f32)temp_s1 / 32768.0) * 25.0) + temp_f24),
		(s16)(s32)((((f64)(f32)coss(temp_s2 & 0xFFFF) / 32768.0) * 25.0) + temp_f26)
	) >> 8;
	temp_s1 = sins(temp_s2 & 0xFFFF);
	inst->unk16 = func_80003824_4424(
		...
		(f32)(sp4C - (func_800B84D0_C7480(
			(s16)(s32)(temp_f24 - (((f64)(f32)temp_s1 / 32768.0) * 25.0)),
			(s16)(s32)(temp_f26 - (((f64)(f32)coss(temp_s2 & 0xFFFF) / 32768.0) * 25.0))
		) >> 8))
	);
	inst->unk12 = 0x140;
	...
	if ((func_8008E478_9D428(arg0) == 0) && (func_8008E30C_9D2BC(arg0, 0x80000000) == 0) && !(sp30->unk20 & 0x120)) {
		if (arg1 != 0) {
			...
			if (sp5F != 0xFF) {
				...
				if ((otherType == -1) || (otherType == (s8)(&D_80050AE9)[sp5F * 0x18])) {
					if (sp5F != sp30->unk38) {
						func_800ACF9C_BBF4C(sp5F);
					}

					func_80080B44_8FAF4(arg0, sp5F);
					sp30->unk16 += *((s16 *)(D_802590A4 + (D_80050ADE[sp5F * 0x18] << 5))) + 0x64;
...
void func_8008F9E4_9E994(u8 arg0) {
	...
	alienIndex = arg0 & 0xFF;
	ai = &alienInstances[alienIndex];
	...
	func_8008F0BC_9E06C(alienIndex, moved);
	...
	if (flags & 0x1000) {
		...
		tmpC = D_8014DD50[D_8014DD50[D_8014DD50[ai->unkC].unkC].unkD].unkD;
		tmpD = D_8014DD50[tmpC].unkD;
		sp36 = D_8014DD50[tmpD].unkD;

		tmpA = ai->unkA;
		if (flags & 0x08000000) {
			sp24 = 0x12C;
		} else {
			sp24 = D_802566D8[ai->specIndex].unk0;
		}

		if (((s16)tmpA < ai->unkA) || (ai->unk47 & 1)) {
			if (!(flags & 0x8000)) {
				ai->unk20 = flags | 0x8000;
				ai->unk20 &= ~0x1000;
				ai->unk36 = 0;
			}
		}

		func_8008F8D4_9E884(alienIndex, sp36);
	} else {
		sp24 = D_802566D8[ai->specIndex].unk0;
		if (flags & 0x08004000) {
			if (ai->unk1E != 0) {
				ai->unk1E -= 1;
			} else if (func_800850DC_9408C(alienIndex, 0x400) != 0) {
				ai->unk20 |= 0x1000;
			}
		} else if (moved && !(flags & 0x2800)) {
			func_8008F6C0_9E670(alienIndex);
		}
	}

	func_800808F0_8F8A0(alienIndex, &ai->unk8);
	ai->unk8 = (s16)(s32)((f64)ai->unk8 * D_80141EF0_150EA0);
	ai->unkE += ai->unk8 / 8;
	temp = func_8008E524_9D4D4(alienIndex, sp24, 2);
	func_8008E978_9D928(alienIndex, temp);
	func_8008EF1C_9DECC(alienIndex);
}
#else
...
void func_8009012C_9F0DC(u8 arg0) {
	...
	inst = (AlienInstance *)((u8 *)alienInstances + (arg0 * 0x50));
	...
	parent = (AlienInstance *)((u8 *)alienInstances + (inst->unk25 * 0x50));
	...
	if ((parentFlags & 0x100) && !(parentFlags & 0x4000)) {
		...
		if (inst->unk47 & 1) {
			targetSpeed = D_802566C0[specIdx * 0x34];
...
void func_80091470_A0420(u8 arg0) {
	...
	if (inst->unk20 & 0x100) {
		...
		if (inst->unk20 & 0x4000) {
			...
			u8 buildingType = (&D_80050AE9)[buildingIdx * 0x18];
		...
		if (alienInstances[parentIdx].unk20 & 0x4000) {
			...
			if ((s8) building->hitPoints < healthLimit) {
				...
				if (found != 0xFF) {
					...
					inst->unk16 += *((s16 *) (D_802590A4 + (D_80050ADE[found * 0x18] << 5))) + 0xC8;
					return;
				}
			...
			inst->unk16 += *((s16 *) (D_802590A4 + (building->buildingType << 5))) + 0xC8;
			return;
		}
...
void func_80092EF4_A1EA4(u8 arg0) {
	...
	s16 sp38;
	{
		...
		if (alien->unk20 & 0x1000) {
			...
			if ((alien->unk47 & 0xE) || (alien->unk2 - alienSpecs[sp3F].unkC) < sp38) {
				if (alien->unk3F != 0xFF) {
					func_800765C4_85574(alien->unk3F);
				}
	...
	if (alien->unk20 & 0x2000) {
		...
		if (currentLevel == 1) {
			...
			if (alien->unk20 & 0x04000000) {
				...
				spB0 = D_8014DD5C[pathWork->unkD * 0x10];
			}
