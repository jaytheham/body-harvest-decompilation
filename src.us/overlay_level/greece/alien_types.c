...
/* Function prototypes referenced by the greece alien spec table. */
/* Defined in the outside gameplay overlay (src.us/overlay_gameplay/outside). */
...
/* Defined in the greece level overlay (src.us/overlay_level/greece/18D7E0.c). */
