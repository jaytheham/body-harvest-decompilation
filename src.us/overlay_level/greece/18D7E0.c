...
void func_802D54AC_18DFBC(void) {
	...
	if ((buildingInstances[63].unk8 >> 0xC) & 0x10) {
		func_8011C080_12B030(0x3F);
		func_800AE190_BD140(3);
	}
	if ((buildingInstances[57].unk8 >> 0xC) & 0x10) {
		func_8011C080_12B030(0x39);
		func_800AE190_BD140(3);
	}
	if ((buildingInstances[62].unk8 >> 0xC) & 0x10) {
...
void func_802D8724_191234(u8 arg0)
{
	...
	new_var2 = func_8008E524_9D4D4(arg0, 0x190, 2);
	func_8008E978_9D928(arg0, new_var2);
...
void func_802D8D84_191894(u8 arg0)
{
	...
	else
	{
		...
		if ((alienInstances[arg0].unk2C % 6) == 0)
		{
			func_80128428_1373D8(&alienInstances[arg0], D_8014DD50[nodeId].unk0, D_8014DD50[nodeId].unk2 - 0x8000, D_8014DD50[nodeId].unk4, &sp60, &sp5C, &sp58);
			if (D_80031420 & 3)
			{
				func_800CA5EC_D959C((s16)sp60, (s16)sp5C, (s16)sp58, 0, 1, 0, 0x32, 5, 6, 0x80, 0, 0xB4 - (func_800038E0_44E0() % 0x50), 0, 0xFF);
			}
		}
		if (((func_80084FE8_93F98(arg0, 0x800) == 0) && (!(alienInstances[arg0].unk20 & ALIEN_FLAG_UNKG))) && (func_80087188_96138(arg0, 0, 0x28) != 0))
		{
			alienInstances[arg0].unk4B = 0;
			alienInstances[arg0].unk20 |= ALIEN_FLAG_UNKG;
			alienInstances[arg0].unk1E = (func_800038E0_44E0() % 0xA) + 8;
		}
		func_800A3D00_B2CB0(arg0, nextNode, 2, &D_802DDCD8_1967E8);
		if (alienInstances[arg0].unk2C == 1)
		{
			func_800DF848_EE7F8(alienInstances[arg0].unk0, alienInstances[arg0].unk2, alienInstances[arg0].unk4, (u16)(((f64)alienTypes[alienInstances[arg0].typeIndex].unkC) * 1.5), 4);
		}
	}
	if (alienInstances[arg0].unk1E != 0)
	{
...
void func_802D911C_191C2C(u8 arg0)
{
	...
	if (alienInstances[arg0].unk20 & ALIEN_FLAG_FALL)
  {
	...
	if (((func_800038E0_44E0() % 100) == 0) && (alienInstances[arg0].unk1E == 0))
  {
		...
		(func_800B325C_C220C(sp37, sp42, 0x1000) != 0))
	{
	  ...
	  {
		sp37 = sp43 + 1;
		if (func_800B325C_C220C(sp37, sp33, 0x1000) &&
			func_800B325C_C220C(sp37, sp42, 0x1000) &&
			func_800B325C_C220C(sp37, sp2F, 0x1000) &&
  ...
  distSq = (((((f32) sins(((arg0 + D_80052A8C) * 0x7D0) & 0xFFFF))) / 32768.0) * D_802DE400_196F10[0]);
  pathA->unk6 = distSq;
  pathB->unk6 = distSq;
  if (alienInstances[arg0].unk1E != 0)
  {
...
void func_802D9964_192474(u8 arg0)
{
	...
	func_802D962C_19213C(arg0, sp4A, sp4C);
	if (D_80052B34->unk1A == 0)
	{
	...
	if (!(alien->unk20 & ALIEN_FLAG_UNKD) && !(alien->unk47 & 1))
	{
		...
		if (func_80086230_951E0(arg0, sp4E, 0x2000) == 0)
		{
			...
			var_v1 = (var_v0 < var_v1) ? BH_ABS_ALT(sp46) : BH_ABS_ALT(sp44);
...
void func_802DA3EC_192EFC(u8 arg0)
{
	...
	dist = (s32)sqrtf((f32)(((alien->unk0 - D_80052B34->unk0) * (alien->unk0 - D_80052B34->unk0)) +
							((alien->unk4 - D_80052B34->unk4) * (alien->unk4 - D_80052B34->unk4))));

	{
		...
		if (dist < 0x212)
		{
			if (((alienInstances[neigh0].unk20 & (ALIEN_FLAG_UNKL | ALIEN_FLAG_UNKD)) == ALIEN_FLAG_UNKD) || ((alienInstances[neigh1].unk20 & (ALIEN_FLAG_UNKL | ALIEN_FLAG_UNKD)) == ALIEN_FLAG_UNKD))
			{
				alien->unk2A -= 0x400;
			}
			else if (((alienInstances[neigh2].unk20 & (ALIEN_FLAG_UNKL | ALIEN_FLAG_UNKD)) == ALIEN_FLAG_UNKD) || ((alienInstances[neigh3].unk20 & (ALIEN_FLAG_UNKL | ALIEN_FLAG_UNKD)) == ALIEN_FLAG_UNKD))
			{
				alien->unk2A += 0x400;
			}
		}
	...
	pathA = D_8014DD5C[alien->unkC].unk0;
	func_80090948_9F8F8(pathA, 0x7D0);
	pathB = D_8014DD5C[pathA].unkD;
	func_80090948_9F8F8((s16)(s32)pathB, 0x7D0);

	pathCounter = alien->unk2C;
	path1 = &D_8014DD50[D_8014DD50[pathB].unkD];
	path2 = &D_8014DD50[path1->unkD];
	path3 = &D_8014DD50[path2->unkD];
	path4 = path3->unkD;

	if ((pathCounter < 2) || (parent->unk20 & ALIEN_FLAG_UNKG))
	{
		if (pathCounter <= 0)
		{
			if (highAlert != 0)
		...
		path3->unk2 = 0;
		D_8014DD50[path4].unk2 = 0;
	}
	else
	{
		path3->unk2 = 0x7D00;
		D_8014DD50[path4].unk2 = 0x7D00;
	}
	...
	if (dist < 0x258)
	{
		...
		{
			if ((alien->unk26 == 0) && (alien->unk1E == 0) && !(parent->unk20 & ALIEN_FLAG_UNKG))
			{
				alien->unk26 = 0x19;
				alien->unkA = 0;
				path1->unk6 = 0;
	...
	if (alien->unk26 != 0)
	{
		if ((alien->unk12 - alienTypes[27].unk3E) < 0)
		{
			alien->unk12 = 0;
		}
		else
		{
			alien->unk12 = alien->unk12 - alienTypes[27].unk3E;
		}
		...
		if (alien->unk26 >= 0x10)
		{
			...
			if (phase == 1)
			{
				func_80128504_1374B4(alien, 1, &out[2], &out[1], &out[0]);
				yaw = alien->unk6;
				if (func_800868A4_95854(arg0, 1, 0, 0) != 0)
				{
					func_80137468_146418(arg0, 0x273);
					func_800DEA08_ED9B8((s16)out[2], (s16)out[1], (s16)out[0], 0xB4, 0xA, 0, 0x1E, 0xC8, 0xA0, 0x96, 0);
					func_800CA5EC_D959C((s16)out[2], (s16)out[1], (s16)out[0],
		...
		else
		{
			...
			phase2 = alien->unk26 % 4;
			alien->unkA = (s16)(s32)((((f64)(f32)coss((u16)((((f32)phase2) / 4) * D_802DE408_196F18[0])) / 32768.0) + 1.0) * D_802DE410_196F20[0]);
	...
	else
	{
		...
		else if ((alien->unk20 & (ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKD)) == (ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKD))
		{
	...
	else if ((alien->unk26 == 0) && ((dist >= 0x321) || (highAlert != 0) || (parent->unk20 & ALIEN_FLAG_UNKG)))
	{
	...
	if ((highAlert != 0) || (parent->unk20 & ALIEN_FLAG_UNKG))
	{
		if (alien->unk26 == 0)
		{
			alien->unkA = (s16)(s32)(((f64)(f32)coss((D_80052A8C * 0x5CC60) & 0xFFFF) / 32768.0) * D_802DE418_196F28[0]);
			path1->unk6 = (u16)(D_802DE428_196F38[0] - ((((f64)(f32)coss((D_80052A8C * 0x3A98) & 0xFFFF) / 32768.0) + 1.0) * D_802DE420_196F30[0]));
			path2->unk6 = (u16)(((((f64)(f32)coss((D_80052A8C * 0x3A98) & 0xFFFF) / 32768.0) + 1.0) * D_802DE430_196F40[0]));
		}

		if (parent->unk20 & ALIEN_FLAG_UNKG)
		{
			alien->unk12 -= alienTypes[27].unk3E;
			if (alien->unk12 < 0)
			{
				alien->unk12 = 0;
			}
		...
		{
			alienTypes[27].unk40 = 0x280;
			alienTypes[27].unk10 = 0;
			alienTypes[27].unk12 = 0;
		}

		if ((highAlert != 0) && (alien->hitPoints < ((s32)alienTypes[27].unk3A >> 1)) && !(D_80052A8C & 1) && (D_80031420 & 3))
		{
	...
	if ((parent->unk20 & ALIEN_FLAG_UNKG) && ((alien->unk2C % 3) == 0))
	{
...
s32 func_802DB16C_193C7C(u8 arg0, Unk8014DD50 **arg1, Unk8014DD50 **arg2) {
   ...
   nodes[1] = D_8014DD50[nodes[0]].unkC;
	sp9F = alienInstances[alienIndex].typeIndex;

	if (alienInstances[alienIndex].unk20 & ALIEN_FLAG_UNKF) {
			result = func_80081F18_90EC8(alienIndex, 3, 4, &nodes[0], arg1);
		if (result == 4) {
			alienInstances[alienIndex].unk20 &= ~ALIEN_FLAG_UNKF;
		}

		   if ((alienInstances[alienIndex].unk36 == 2) && (D_8014DD50[nodes[0]].unkE == 0)) {
			func_80128504_1374B4(&alienInstances[alienIndex], 1, &sp88, &sp84, &sp80);
			...
			func_80137468_146418(alienIndex, 0x259);
			func_80135D44_144CF4(sp88, sp84, sp80, 5.0f);

			if (func_800879A4_96954(alienIndex, 0x50, 1) != 0) {
				func_80122524_1314D4(D_80052B34, 0x7D0, alienInstances[alienIndex].unk0, alienInstances[alienIndex].unk4);

				if (D_80052B34->unk1A != 0) {
					func_80137468_146418(alienIndex, 0x258);
					sp70 = (f32)((f32)sins((u16)(alienInstances[alienIndex].unk6 + 0x4000)) / 32768.0);
					func_800C541C_D43CC(D_80052B34->unk0, D_80052B34->unk2, D_80052B34->unk4, (s8)(s32)(sp70 * 127.0f), -0x50,
						(s32)((f32)-((f32)coss((u16)(alienInstances[alienIndex].unk6 + 0x4000)) / 32768.0) * 127.0f),
	...
	if (alienInstances[alienIndex].unk20 & ALIEN_FLAG_UNKD) {
		result = func_80081F18_90EC8(alienIndex, 3, 3, &nodes[0], arg1);
		if (result == 3) {
		...
		if (result == 2) {
			s32 randVal;
			func_80137468_146418(alienIndex, 0x131);
			if (!(D_80052B34->unk20 & VEHICLE_FLAG_AIRBORNE) && (func_800879A4_96954(alienIndex, 0x50, 0) != 0)) {
				sp94 = D_80052B34->unk0 - alienInstances[alienIndex].unk0;
				sp90 = D_80052B34->unk4 - alienInstances[alienIndex].unk4;
				...
				if (D_80052B34->unk1A == 0) {
					...
					func_80122524_1314D4(D_80052B34, 0x3E8, alienInstances[alienIndex].unk0, alienInstances[alienIndex].unk4);
				}
...
void func_802DC1B8_194CC8(u8 arg0, s32 arg1) {
	...
	if (alienInstances[arg0].unk20 & (ALIEN_FLAG_UNKA | ALIEN_FLAG_UNKB)) {
		...
		func_800DF038_EDFE8((s16)sp40, (s16)sp3C, (s16)sp38,
			alienTypes[alienInstances[arg0].typeIndex].unkC, arg1, 0);
	}
}
...
void func_802DC2E4_194DF4(u8 arg0)
{
	...
	y = sp50[1];
	z = sp50[2];
	temp = func_800DF038_EDFE8((u16)x, (u16)y, (u16)z, alienTypes[alien->typeIndex].unkC, 0, 0);
	func_800C7924_D68D4(x, y, z, 0x40, temp, 0xC8, sp40, 1);

	func_80088E10_97DC0(sp5C);
	alienInstances[alienInstances[alien->unk25].unk25].unk20 |= ALIEN_FLAG_UNKG;
...
void func_802DCADC_1955EC(u8 arg0)
{
	...
	tmpB = D_8014DD50[alienInstances[arg0].unkC].unkC;
	tmpA = D_8014DD50[tmpB].unkD;
	obj2 = D_8014DD50[tmpA].unkD;
	obj3 = D_8014DD50[obj2].unkD;
	obj4 = D_8014DD50[obj3].unkD;
	obj5 = D_8014DD50[obj4].unkD;

	if (alienInstances[arg0].unk2C >= 0x51)
	{
		D_8014DD50[obj4].unk2 = 0;
		D_8014DD50[obj5].unk2 = 0;

		D_8014DD50[obj2].unk6 = (u16)(65535.0 - (((((f32)coss((u16)(D_80052A8C * 0x4E20)) / 32768.0) + 1.0) * 2000.0)));
		D_8014DD50[obj3].unk6 = (u16)(((((f32)coss((u16)(D_80052A8C * 0x4E20)) / 32768.0) + 1.0) * 2000.0));
	...
	{
		D_8014DD50[obj4].unk2 = 0x7D00;
		D_8014DD50[obj5].unk2 = 0x7D00;
		...
		if ((u16)D_8014DD50[tmpA].unkA < 0x2710)
		{
			D_8014DD50[tmpA].unkA = (u16)((u16)D_8014DD50[tmpA].unkA + 0x3E8);
		}
	}

	{
		...
		if (!(alienInstances[arg0].unk20 & ALIEN_FLAG_UNKL))
		{
			...
			func_800A92B0_B8260();
			alienInstances[arg0].unk2C = 0x10E;
			func_800DF848_EE7F8(alienInstances[arg0].unk0, alienInstances[arg0].unk2, alienInstances[arg0].unk4, alienTypes[27].unkC, 8);
			func_80137468_146418(arg0, 0x11);
			return;
		}

		if (alienInstances[arg0].unk2C < 0xAB)
		{
			func_800AA340_B92F0(arg0);

			if ((alienInstances[arg0].unk2C < 0x51) && (alienInstances[arg0].unk2C >= 0x29) && !(D_80052A8C & 7))
			{
				func_80128504_1374B4(&alienInstances[arg0], 1, &sp6C, &sp68, &sp64);
				angle = alienInstances[arg0].unk6;
				...
				if (D_80031420 & 3)
				{
					func_800CA5EC_D959C(
						...
						(s16)sp68,
						(s16)sp64,
						(s8)(s32)((((f32)coss(angle) / 32768.0) * 100.0)),
						-0x14,
						(s32)((((f32)sins(angle) / 32768.0) * 100.0)),
						0x64,
						0xA,
						0x1E,
						0x64,
		...
		else
		{
			...
			if (alienInstances[arg0].unk2C >= 0xFA)
			{
				alienInstances[arg0].unkA -= 0xC8;
				return;
			}

			if (alienInstances[arg0].unk2C < 0xBF)
			{
				alienInstances[arg0].unkA += 0xC8;
				return;
			}

			if (((alienInstances[arg0].unk2C + 1) % 10) == 0)
			{
				func_80128504_1374B4(&alienInstances[arg0], 1, &sp6C, &sp68, &sp64);
				angle = alienInstances[arg0].unk6;
