...
u8 D_802E04A0_1F91B0 = 0xFF;

void (*D_802E04A4_1F91B4[])(s32) = {
	(void (*)(s32))0x802D50B0,
	(void (*)(s32))0x802D5170,
	(void (*)(s32))0x802D5560,
	(void (*)(s32))0x802D5BF8,
...
Unk802E04F8Entry D_802E04F8_1F9208[] = {
	{ 0xFFFD, 0x2854, 0xCECC, 0x00C8 },
	{ 0xFFFD, 0x24A4, 0xE8E4, 0x0096 },
	{ 0xFFFD, 0x1FE4, 0xE5E0, 0x0096 },
	{ 0xFFFD, 0x1928, 0xDF2C, 0x0096 },
	{ 0xFFFD, 0x2218, 0xDE1C, 0x0096 },
	{ 0xFFFD, 0x2064, 0xE5BC, 0x0096 },
	{ 0xFFFD, 0x21E0, 0xDE5C, 0x0096 },
	{ 0xFFFD, 0x2CE0, 0xE194, 0x0096 },
	{ 0xFFFD, 0x338C, 0xE688, 0x0096 },
	{ 0xFFFD, 0xFA50, 0xA44C, 0x0096 },
	{ 0xFFFD, 0xF490, 0xA488, 0x0096 },
	{ 0xFFFD, 0xEF66, 0x9658, 0x0096 },
	{ 0xFFFD, 0xEFC9, 0x9D1C, 0x0096 },
	{ 0xFFFD, 0xF3AD, 0x9D10, 0x0096 },
};

s32 D_802E0568_1F9278 = 0x45284827;
s16 D_802E056C_1F927C = 0;

s8 D_802E0570_1F9280[] = {
	0x06, 0x0C, 0x0D, 0x18, 0x14, 0x0B, 0x1F, 0x02,
	0x1C, 0xFB, 0x0E, 0xF1, 0x1D, 0xF1, 0x09, 0xE8,
};

u32 D_802E0580_1F9290[] = {
	0x00000000, 0xFFD80000, 0x00000000, 0x01000001,
	0x00000000, 0x00000000, 0x00000000, 0x01000003,
};

u32 D_802E05A0_1F92B0[] = {
	0x00000034, 0x00000000, 0x00000000, 0x01000001,
	0x00000030, 0x00000000, 0x00000000, 0x01000003,
};

Unk8014DD50 *D_802E05C0_1F92D0 = (Unk8014DD50 *)D_802E0580_1F9290;
Unk8014DD50 *D_802E05C4_1F92D4 = (Unk8014DD50 *)D_802E05A0_1F92B0;

u32 D_802E05C8_1F92D8[] = {
	0x00000000, 0x00000000, 0x0000DCD8, 0x00010002,
	0x00000000, 0x00000000, 0x00000000, 0x00010007,
};

u32 D_802E05E8_1F92F8[] = {
	0x00000000, 0x00000000, 0x00001F40, 0x00010002,
	0x00000000, 0x00000000, 0x00000000, 0x00010007,
};

Unk8014DD50 *D_802E0608_1F9318 = (Unk8014DD50 *)D_802E05C8_1F92D8;
Unk8014DD50 *D_802E060C_1F931C = (Unk8014DD50 *)D_802E05E8_1F92F8;

Unk8014DD50 D_802E0610_1F9320[] = {
	{ 0x0000, 0x0000, 0x0000, 0x251C, 0x0000, 0x0000, 0x00, 0x01, 0x000A },
	{ 0x0000, 0x0000, 0x0000, 0x38A4, 0x0000, 0x0000, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x251C, 0x0000, 0x0000, 0x00, 0x01, 0x000F },
	{ 0x0000, 0x0000, 0x0000, 0xA240, 0x0000, 0x0000, 0x00, 0x01, 0x000A },
	{ 0x0000, 0x0000, 0x0000, 0xD120, 0x0000, 0x0000, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0xC180, 0x0000, 0x0000, 0x00, 0x01, 0x000F },
	{ 0x0000, 0x0000, 0x0000, 0xD8F0, 0x0000, 0x0000, 0x00, 0x01, 0x000A },
	{ 0x0000, 0x0000, 0x0000, 0xC950, 0x0000, 0x0000, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0xD8F0, 0x0000, 0x0000, 0x00, 0x01, 0x000F },
	{ 0x0000, 0x0000, 0x0000, 0x6658, 0x0000, 0x0000, 0x00, 0x01, 0x000A },
	{ 0x0000, 0x0000, 0x0000, 0x3778, 0x0000, 0x0000, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x4718, 0x0000, 0x0000, 0x00, 0x01, 0x000F },
};

Unk8014DD50 *D_802E06D0_1F93E0 = D_802E0610_1F9320;
Unk8014DD50 *D_802E06D4_1F93E4 = &D_802E0610_1F9320[3];
Unk8014DD50 *D_802E06D8_1F93E8 = &D_802E0610_1F9320[6];
Unk8014DD50 *D_802E06DC_1F93EC = &D_802E0610_1F9320[9];

Unk8014DD50 D_802E06E0_1F93F0[] = {
...
Unk8014DD50 D_802E0710_1F9420[] = {
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x1F40, 0x00, 0x01, 0x0002 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0007 },
	{ 0x0000, 0x0000, 0x0000, 0xA628, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0xE2B4, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0xCB44, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0xA628, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0xE2B4, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0xCB44, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0xA628, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0xE2B4, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0xCB44, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0xCB44, 0x0000, 0x0000, 0x00, 0x01, 0x004B },
	{ 0x0000, 0x0000, 0x0000, 0x2AF8, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0x4268, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0x4A38, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x2AF8, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0x4268, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0x4A38, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x2AF8, 0x0000, 0x0000, 0x00, 0x01, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0x4268, 0x0000, 0x0000, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0x4A38, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x4A38, 0x0000, 0x0000, 0x00, 0x01, 0x004B },
};

Unk8014DD50 *D_802E0870_1F9580 = &D_802E0710_1F9420[2];
Unk8014DD50 *D_802E0874_1F9584 = &D_802E0710_1F9420[12];

s8 D_802E0878_1F9588[] = {
	0x78, 0x1E, 0x00, 0xFA, 0x46, 0x00, 0x50, 0x14,
	0x00, 0x50, 0x14, 0x00,
};

u8 D_802E0884_1F9594[] = {
	0x50, 0xC8, 0xF5, 0xC8, 0x00, 0xFF, 0xFF, 0x14,
	0x6F, 0x1E, 0xF0, 0x8C,
};

Unk8014DD50 D_802E0890_1F95A0[] = {
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x07D0, 0x00, 0x01, 0x0002 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xE0C0, 0x00, 0x01, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xDAE4, 0x00, 0x00, 0x0004 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xD8F0, 0x00, 0x00, 0x0006 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x000E },
	{ 0xFFB6, 0xFFE5, 0xFFC4, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0003 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x0008 },
	{ 0xFFB6, 0xFFE5, 0xFFC4, 0x0000, 0xC180, 0x0000, 0x01, 0x01, 0x0005 },
	{ 0xFFB6, 0xFFE5, 0xFFC4, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x0004 },
	{ 0xFFB6, 0xFFE5, 0xFFEA, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0003 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x000F },
	{ 0x0045, 0xFFE5, 0xFFC4, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0003 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x0008 },
	{ 0x0045, 0xFFE5, 0xFFC4, 0x0000, 0x3E80, 0x0000, 0x01, 0x01, 0x0005 },
	{ 0x0045, 0xFFE5, 0xFFC4, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x0004 },
	{ 0x0045, 0xFFE5, 0xFFEB, 0x0000, 0x0000, 0x0000, 0x01, 0x01, 0x0003 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x000F },
};

Unk8014DD50 *D_802E09C0_1F96D0 = &D_802E0890_1F95A0[5];
Unk8014DD50 *D_802E09C4_1F96D4 = &D_802E0890_1F95A0[12];

Unk8014DD50 D_802E09C8_1F96D8[] = {
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF0B7, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x159E, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x159E, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xEBAA, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0222, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0222, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF223, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFE82, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFE82, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xEFB8, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFDF1, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFDF1, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF8E4, 0x00, 0x01, 0x0014 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF99A, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xF99A, 0x00, 0x01, 0x0005 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x01, 0x0014 },
};

Unk8014DD50 *D_802E0B08_1F9818 = D_802E09C8_1F96D8;
Unk8014DD50 *D_802E0B0C_1F981C = &D_802E09C8_1F96D8[4];
Unk8014DD50 *D_802E0B10_1F9820 = &D_802E09C8_1F96D8[8];
Unk8014DD50 *D_802E0B14_1F9824 = &D_802E09C8_1F96D8[12];
Unk8014DD50 *D_802E0B18_1F9828 = &D_802E09C8_1F96D8[16];
Unk8014DD50 *D_802E0B1C_1F982C = NULL;

Unk8014DD50 D_802E0B20_1F9830[] = {
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xF78A, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xF78A, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0023, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x082D, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xF6D4, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xF6D4, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0023, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0926, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xD877, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xD877, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0023, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0A49, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xDCF2, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xDCF2, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0023, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xFE64, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xD0C9, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xD0C9, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0023, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0x3D0F, 0x0001, 0x0014, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xCC17, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
	{ 0x0000, 0x0000, 0x0000, 0xCC17, 0x0001, 0x0005, 0x00, 0x00, 0x0000 },
};

u32 D_802E0C90_1F99A0[] = { 0x00000000, 0x00000000, 0x00010023 };

Unk8014DD50 *D_802E0C9C_1F99AC = (Unk8014DD50 *)0x802E0B1C;
Unk8014DD50 *D_802E0CA0_1F99B0 = (Unk8014DD50 *)0x802E0B5C;
Unk8014DD50 *D_802E0CA4_1F99B4 = (Unk8014DD50 *)0x802E0B9C;
Unk8014DD50 *D_802E0CA8_1F99B8 = (Unk8014DD50 *)0x802E0BDC;
...
AlienType D_802E0CE4_1F99F4 = {
	...
	0x0800,                         /* unk42 */
	NULL,                           /* unk44 */
	(void (*)(u8))0x802DF99C,       /* unk48 */
	(void *)0x802DF99C,             /* unk4C */
	0xFF,                           /* unk50 */
	0x00,                           /* unk51 */
	0x00,                           /* unk52 */
	0x00,                           /* unk53 */
...
const char D_802E0D50_1F9A60[] = "Unwritten Java Function %d\n";
const char D_802E0D6C_1F9A7C[] = "bladam creation fuckup\n";
const char D_802E0D84_1F9A94[] = "Destroyed alien holding cable car\n";
const char D_802E0DA8_1F9AB8[] = "Destroyed battery blob\n";
const char D_802E0DC0_1F9AD0[] = "JAVA: Request native hut height map\n";
const char D_802E0DE8_1F9AF8[] = "JAVA: Start humans exiting\n";
const char D_802E0E04_1F9B14[] = "All done\n\n\n";
const char D_802E0E10_1F9B20[] = "Init\n";
const char D_802E0E18_1F9B28[] = "finishing\n";
const char D_802E0E24_1F9B34[] = "add human\n";
const char D_802E0E30_1F9B40[] = "end evac\n";
const char D_802E0E3C_1F9B4C[] = "stop boat damage\n";
const char D_802E0E50_1F9B60[] = "4:%d\n";
const char D_802E0E58_1F9B68[] = "5:%d\n";
const char D_802E0E60_1F9B70[] = "Lava pools killed\n";
const char D_802E0E74_1F9B84[] = "Damage\n";
const char D_802E0E7C_1F9B8C[] = "CREATE LIGHTNING!\n";

const u32 jtbl_802E0E90_1F9BA0[] = {
	0x802D522C, 0x802D5278, 0x802D5320, 0x802D538C,
	0x802D54C0, 0x802D54EC,
};

const f64 D_802E0EA8_1F9BB8[] = { 1000.0 };
const f64 D_802E0EB0_1F9BC0[] = { 1.7 };

const u32 jtbl_802E0EB8_1F9BC8[] = {
	0x802D6374, 0x802D63F0, 0x802D6440, 0x802D6480,
	0x802D6528, 0x802D66AC, 0x802D6794,
};

const f64 D_802E0ED8_1F9BE8[] = { 0.325 };
const f32 D_802E0EE0_1F9BF0[] = { 0.4f };
const f32 D_802E0EE4_1F9BF4[] = { 2500.0f };
const f32 D_802E0EE8_1F9BF8[] = { 1500.0f };
const f64 D_802E0EF0_1F9C00[] = { 0.075 };
const f64 D_802E0EF8_1F9C08[] = { 0.325 };
const f32 D_802E0F00_1F9C10[] = { 2500.0f };
const f32 D_802E0F04_1F9C14[] = { 1500.0f };
const f64 D_802E0F08_1F9C18[] = { 0.075 };
const f64 D_802E0F10_1F9C20[] = { 0.325 };
const f64 D_802E0F18_1F9C28[] = { 0.325 };

const u32 jtbl_802E0F20_1F9C30[] = {
	0x802D79B0, 0x802D79D8, 0x802D79FC, 0x802D7A24,
	0x802D7A4C, 0x802D7A74, 0x802D7A9C, 0x802D7B58,
	0x802D7B58, 0x802D7AC4, 0x802D7AEC, 0x802D7B14,
	0x802D7B3C, 0x802D7B58,
};

const f64 D_802E0F58_1F9C68[] = { 4000.0 };
const f64 D_802E0F60_1F9C70[] = { 188.0 };
const f64 D_802E0F68_1F9C78[] = { -166.0 };
const f64 D_802E0F70_1F9C80[] = { -166.0 };
const f32 D_802E0F78_1F9C88[] = { 5000.0f };
const f64 D_802E0F80_1F9C90[] = { 70.0 };
const f32 D_802E0F88_1F9C98[] = { 549.31640625f };
const f32 D_802E0F8C_1F9C9C[] = { 2250000.0f };
const f64 D_802E0F90_1F9CA0[] = { 3000.0 };
...
void func_802D4CD0_1ED9E0(s32 arg0, void *arg1) {
	...
	case 0x44:
		...
		break;
	default:
		osSyncPrintf(&D_802E0D50_1F9A60, arg0);
		break;
	}
}
#else
	...
	case 3:
		...
		if (temp == 0) {
			...
			for (temp = 0; temp < 0xFF; temp++) {
				if (alienInstances[temp].typeIndex == 7 &&
	...
	if (vehicleInstances[80].unk1C <= 0) {
		...
		if (var_v0 > 0) {
			...
			do {
				...
				func_800C7924_D68D4(vehicleInstances[80].unk0, (s16) (vehicleInstances[80].unk2 + 0xA), vehicleInstances[80].unk4, 0x10, (s32) temp_s6, vehicleTypes[vehicleInstances[80].unk1A].unk36 * 2, &D_502D390, 1);
				var_s1 += 1;
				if (D_801591C4 >= 9) {
					var_v0_2 = 8;
				} else {
...
s32 func_802D57F4_1EE504(void) {
	...
	case 0:
		...
		temp_v0 = D_80157F8E;
		if (temp_v0 == 1) {
			osSyncPrintf(&D_802E0DC0_1F9AD0);
	...
	case 1:
		...
		alienTypes[0].unkBC = (s32) (alienTypes[0].unkBC & ~2);
		if (temp_v0_2 == 5) {
			osSyncPrintf(&D_802E0DE8_1F9AF8);
	...
	case 2:
		if (D_802E056C_1F927C == 0xB4) {
			func_800C0D1C_CFCCC(-0x50, 0x50, 0);
		}
		if ((D_802E056C_1F927C == 0x91) || (D_802E056C_1F927C == 0xC8)) {
	...
	case 3:
		alienTypes[0].unkBC = (s32) (alienTypes[0].unkBC | 2);
		osSyncPrintf(&D_802E0E04_1F9B14);
		D_802E0FB0 = 0;
...
void func_802D5BA0_1EE8B0(void) {
	osSyncPrintf(&D_802E0E30_1F9B40);
	D_802E0FB0 = 0;
...
void func_802D5FE4_1EECF4(void) {
	...
	var_s0 = &D_802E0570_1F9280;
	var_s3 = &D_802E0580_1F9290;
	var_s2 = 0xFF;
	temp_f20 = D_802E0EB0_1F9BC0;
	temp_f22 = 0.0;
...
s32 func_802D6338_1EF048(void) {
	...
	case 4:
		...
		osSyncPrintf(&D_802E0E50_1F9B60, D_80157F8E);
		if (D_802E04A0_1F91B0 != 0xFF) {
	...
	case 5:
		...
		osSyncPrintf(&D_802E0E58_1F9B68, D_80157F8E);
		if (D_80157F8E == 1) {
			func_8011C080_12B030(0x32);
			func_800DF038_EDFE8(buildingInstances[49].xCoord, (s16) (D_80222A70 + 0x96), buildingInstances[49].zCoord, 0x12C, 8, 0);
			func_800DF038_EDFE8(buildingInstances[50].xCoord, (s16) (D_80222A70 + 0x96), buildingInstances[50].zCoord, 0x12C, 0x10, 0);
...
void func_802D6E70_1EFB80(void) {
	...
	temp_v0 = *(&D_80031634_32234 + ((currentLevel - 1) * 4));
	if ((D_80047F94 == 2) && (D_8003154C[currentLevel - 1][2].state == 0)) {
	...
	sp4C = temp_f10;
	if (D_80047F94 != 3) {
		func_801371B8_146168((s32)(&D_802E0FBA), 0x18C, D_80052B34->unk0, (s16) (D_80052B34->unk2 - 0xFA0), (s32) D_80052B34->unk4, (f32) ((f64) temp_f10 + D_802E0ED8_1F9BE8));
	...
	if (D_80047F94 == 3) {
		...
		if (temp_v1 >= 0x3C01) {
			osSyncPrintf((s32)(&D_802E0E74_1F9B84));
			func_801371B8_146168((s32)(&D_802E0FBA), 0x18C, D_80052B34->unk0, (s16) (D_80052B34->unk2 - 0x5DC), (s32) D_80052B34->unk4, D_802E0EE0_1F9BF0);
			...
			if (temp_v1 >= 0x2301) {
				...
				func_801371B8_146168((s32)(&D_802E0FBA), 0x18C, D_80052B34->unk0, (s16) (D_80052B34->unk2 - (s32) ((D_802E0EE4_1F9BF4 * temp_f2) + D_802E0EE8_1F9BF8)), (s32) temp_v1, (f32) (((f64) (1.0f - temp_f2) * D_802E0EF0_1F9C00) + D_802E0EF8_1F9C08 + temp_f0));
				...
				func_801371B8_146168((s32)(&D_802E0FBA), 0x18C, D_80052B34->unk0, (s16) (D_80052B34->unk2 - (s32) ((D_802E0F00_1F9C10 * temp_f2_2) + D_802E0F04_1F9C14)), (s32) temp_v1, (f32) (((f64) (1.0f - temp_f2_2) * D_802E0F08_1F9C18) + D_802E0F10_1F9C20 + temp_f0));
				...
				func_801371B8_146168((s32)(&D_802E0FBA), 0x18C, D_80052B34->unk0, (s16) (D_80052B34->unk2 - 0xFA0), (s32) temp_v1, (f32) (temp_f0 + D_802E0F18_1F9C28));
				if ((((u32) D_80052A8C % 100U) == 0) && ((func_800038E0_44E0() % 10) == 0)) {
					osSyncPrintf((s32)(&D_802E0E7C_1F9B8C));
					func_800C0D1C_CFCCC(-0x50, 0x50, 0);
				}
			}
		}
...
// CURRENT(1291) - uses s16 sp38[2] instead of sp38/sp3A
#ifdef NON_MATCHING
void func_802D7B68_1F0878(u8 arg0) {
	...
	D_8014DD50[sp5E].unk6 = s0->unk6;
	func_80086164_95114(arg0, sp5C);
	D_8014DD50[sp5C].unk6 = -s0->unk6;
	sp50[0] = 0x3C;
	sp50[1] = -8;
	sp50[2] = 0x70;
	...
	if ((func_8000726C_7E6C((u64)0x11) != 0) && (func_8000726C_7E6C((u64)0x2C) == 0) && (func_80084FE8_93F98(arg0, 0x418) != 0)) {
		s0->unk20 &= ~ALIEN_FLAG_PLAYER;
		s0->unk14 = buildingInstances[50].xCoord;
		s0->unk16 = buildingInstances[50].yCoord;
		s0->unk18 = buildingInstances[50].zCoord;
		...
		if ((func_80084FE8_93F98(arg0, 0x830) != 0) && (sp40 < 0x7D0)) {
			s0->unk26++;
		...
		if (s0->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKD)) {
			...
			sp38[1] = sp56;
			if (func_80081F18_90EC8(arg0, 2, 2, sp38, &D_802E05C0_1F92D0) == 2) {
...
void func_802D91F8_1F1F08(u8 arg0) {
	...
	temp_t9 = (temp_s0->unk1A * 0x68) + &alienTypes;
	sp54 = temp_t9;
	...
	if ((temp_s0->unk20 & ALIEN_FLAG_PLAYER) || (sp68 = temp_t0, var_t0 = temp_t0, (func_800859F4_949A4(arg0) != 0))) {
		sp68 = temp_t0;
		...
		if ((temp_s0->unk48 == 1) && (temp_s0->unk3C == 0)) {
			...
			if (!(temp_a1 & 0x1000) && (currentLevel == 3)) {
				temp_s0->unk20 = (s32) (temp_a1 | ALIEN_FLAG_UNKD);
				temp_s0->unk3C = 0x3C;
			}
		}
	...
	if (!(temp_s0->unk20 & ALIEN_FLAG_UNKD) && (temp_s0->unk3C != 0) && (temp_s0->unk4E != 0) && !(temp_s0->unk47 & 1)) {
	...
	if ((spBA != -1) && (temp_a1_2 = temp_s0->unk20, (temp_a1_2 & 0x08000000))) {
		if (temp_a1_2 & 0x6000) {
			...
			if ((var_v0_2 == 2) || (temp_s0->unk36 == 2)) {
				...
				if (temp_s0->unk20 & ALIEN_FLAG_UNKF) {
			...
			if (spAF == 3) {
				temp_s0->unk20 = (s32) (temp_s0->unk20 & ~(ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKF));
			}
		} else {
			...
			if (((temp_v0_9 * temp_v0_9) + (temp_a0_2 * temp_a0_2)) < 0x1D4C0) {
				if (temp_s0->unk2A < temp_s0->unkE) {
					temp_s0->unk20 = (s32) (temp_a1_2 | ALIEN_FLAG_UNKF);
				} else {
					temp_s0->unk20 = (s32) (temp_a1_2 | ALIEN_FLAG_UNKE);
				}
				temp_s0->unk36 = 0U;
			}
		}
...
void func_802D9CB8_1F29C8(u8 alienIdx) {
	...
	if ((alien->unk2C % 25 == 0) && (alien->unk2C >= 0x19)) {
		...
		fltVal = (f32)(((f64)alienTypes[alien->typeIndex].unkC * 0.75));
...
void func_802DA18C_1F2E9C(u8 arg0, s16 arg1, s16 arg2) {
	alienInstances[arg0].unk20 = alienInstances[arg0].unk20 | ALIEN_FLAG_UNKD;
...
void func_802DAFD0_1F3CE0(u8 arg0, s16 arg1) {
	...
	if (sp47 == 2 || sp47 == 5 || sp47 == 8) {
		func_80137468_146418(arg0, 0xCC);
	}

	temp_s0 = &alienInstances[arg0];

	if (temp_s0->unk4B == 2 || temp_s0->unk4B == 5 || temp_s0->unk4B == 8) {
		temp_v0_3 = &alienTypes[temp_s0->typeIndex];
		temp_v0_3->unk20 = 0;
		temp_v0_3->unk22 = -0x14;
		temp_v0_3->unk24 = 0x3C;

		if (func_800879A4_96954(arg0, 0x1E, 0) != 0) {
			func_80122524_1314D4(D_80052B34, 0x28, temp_s0->unk0, temp_s0->unk4);
		}
	}

	if (sp47 == 0xA) {
		temp_s0->unk20 &= ~(ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF);
		temp_s0->unk47 |= 1;
		temp_s0->unk34 = (func_800038E0_44E0() >> 0xB) + 0x20;
		temp_s0->unk4B = 0xFF;
	}
}
#else
...
void func_802DB14C_1F3E5C(u8 arg0) {
	...
	var_a3 = temp_a3;
	if (var_a3->unk20 & ALIEN_FLAG_FALL) {
		temp_t0 = vehicleTypes[D_80052B34->unk1A].unkC + 0x23;
		if ((temp_v0_2 != 0) && !(var_a3->unk47 & 1)) {
			var_a3->unk12 = alienTypes[var_a3->unk1A].unk40;
		}
		if ((var_a3->unk20 & ALIEN_FLAG_UNKG) && (var_a3->unk4B == 0xA)) {
			sp1C = var_a3;
		...
		var_a3 = sp1C;
		if (var_a3->unk20 & ALIEN_FLAG_UNKD) {
			var_v0 = var_a3->unk36;
			if ((s32) var_v0 < 3) {
				if (sp18->unkE == 0) {
					if ((s32) var_v0 < 2) {
	...
	if ((var_v1 < 0x64) && !(var_a3->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF))) {
		sp1C = var_a3;
		if (func_80084FE8_93F98(arg0, 0x800, var_a2, var_a3) != 0) {
			var_a3->unk4B = 0;
			var_a3->unk20 = (s32) (var_a3->unk20 | ALIEN_FLAG_UNKG);
		}
	}
	if (var_a3->unk20 & ALIEN_FLAG_UNKG) {
...
void func_802DB7A4_1F44B4(u8 arg0) {
	...
	temp = alien->unk20 & (ALIEN_FLAG_UNKA | ALIEN_FLAG_UNKB);
	if (temp == 0) {
		return;
	}
	if (!(alien->unk20 & ALIEN_FLAG_UNKL)) {
		if (temp != 0) {
			func_800DF848_EE7F8(alien->unk0, alien->unk2, alien->unk4, (u16)(u32)((f64)alienTypes[typeIndex].unkC * 0.75), 0);
		}
		alien->unk2C = 0x7FFF;
		alien->unk20 |= ALIEN_FLAG_FALL;
		return;
	...
	if (((alien->unk20 & ALIEN_FLAG_FALL) == 0) || ((alien->unk47 & 1) != 0)) {
		if (alien->unk2C >= 0x4C) {
			if (D_80222A70 >= alien->unk2) {
				func_800DF848_EE7F8(alien->unk0, alien->unk2, alien->unk4, (u16)(alienTypes[arg0].unkC * 3), 0);
				stk = 2;
	...
	if (alien->unk2C == 1) {
		stk = (u16)(alienTypes[typeIndex].unkC * 2);
...
void func_802DC230_1F4F40(u8 arg0) {
	...
	alien = &alienInstances[arg0];
	if (!(alien->unk20 & ALIEN_FLAG_UNKE)) {
		if (func_8011E6FC_12D6AC(alien->unk0, alien->unk4, &sp56) != -1) {
			alien->unk20 |= ALIEN_FLAG_UNKD;
			alien->unk2 = sp56 - 0x1E;
		}
	}
	if (func_80084E54_93E04(D_80052B34, alien) < 0x5DC) {
		if (alien->unk2 < D_80052B34->unk2 || (alien->unk20 & ALIEN_FLAG_UNKD)) {
	...
	if (alien->unk20 & ALIEN_FLAG_UNKP) {
		temp = func_800038E0_44E0();
		temp = temp % 4;
		func_800CA5EC_D959C(alien->unk0, (s16)(alien->unk2 + 0x80), alien->unk4, 0, 0x7F, 0, 0x5A, 0xC, 0xA, 0xFF, D_802E0884_1F9594[temp * 3], D_802E0884_1F9594[temp * 3 + 1], D_802E0884_1F9594[temp * 3 + 2], 0x96);
	}
...
void func_802DC738_1F5448(u8 arg0) {
	...
	alien = &alienInstances[arg0];
	sp77 = alien->unk36;
	type_base = &D_8014DD50[alien->unkC * 0x10];
	sp75 = type_base[type_base->unkC * 0x10].unkD;
	sp40 = sp77 & 0xFF;

	if ((sp77 & 0xFF) < 4) {
		type_base = &D_8014DD50[(sp75 & 0xFF) * 0x10];
		angle = type_base->unk0;
		sp6C = angle + 0x17;
		param = type_base->unkA & 0xFFFF;
		sp38 = param;

		sp48 = coss(param);

		/* Compute y position offset using trig value */
		sp68 = (s32)(((f64)type_base->unk2 + D_802E0F68 * ((f64)(f32)sp48 / 32768.0)));

		sp48 = sins(type_base->unkA);
		cos_val = (f32)coss(type_base->unkA);
		sp64 = (s32)((f64)type_base->unk4 + D_802E0F70 * (((f64)(f32)sp48 / 32768.0)));

		sp34 = sp64;

		/* Call animation update with computed parameters */
		func_80128428_1373D8(alien, type_base->unkA, (s16)sp38, (s16)sp64, &sp60, &sp5C, &sp58);
	...
	if (D_8014DD50[(sp75 & 0xFF) * 0x10].unkE == 0) {
		if (sp40 == 3) {
			type_base = &alienTypes[alien->unk1A];
			type_base->unk20 = 0;
			alien->unk1E = 0;
			type_base->unk22 = (s16)sp68;
			type_base->unk24 = (s16)sp64;
		...
		if (sp40 < 5) {
			...
			alien->unk20 = alien->unk20 & ~(ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKE);
		}
...
void func_802DCA54_1F5764(u8 arg0) {
	...
	do {
		...
		if (temp_s1->health < (alienTypes[temp_s1->type].unk58 + var_v0)) {
			var_s7 = 1;
			if (var_s2 < var_v0) {
				var_s2 = var_v0;
			}
...
void func_802DCDD4_1F5AE4(u8 arg0) {
	...
	func_800873A8_96358(arg0);
	alien = &alienInstances[arg0];
	alien->unk20 = (s32) (alien->unk20 & ~ALIEN_FLAG_UNK5);
...
void func_802DCE34_1F5B44(u8 arg0) {
	...
	if (alien->unk20 & (ALIEN_FLAG_UNKA | ALIEN_FLAG_UNKB)) {
		sp3C = alien->typeIndex;
		sp46 = alien->unk0;
		sp44 = alien->unk4;
		result = func_800B84D0_C7480(alien->unk0, alien->unk4);
		type = &alienTypes[sp3C];
		if ((type->unk58 + (result >> 8)) < alien->unk2) {
			...
			type = &alienTypes[sp3C];
			result = func_800B84D0_C7480(alien->unk0, alien->unk4);
			alien->unk2 = (s16) (type->unk58 + (result >> 8));
		}
...
void func_802DD294_1F5FA4(u8 arg0) {
	...
	if ((temp_f10 == 0) || (alien->unk12 >= (temp_a0 - (type->unk3E * 2)))) {
...
void func_802DD5CC_1F62DC(u8 arg0) {
	...
	if (var_a0 & 0x1000) {
		...
		if (var_v1 == 7) {
			alien_instance->unk20 = (s32)(alien_instance->unk20 & ~ALIEN_FLAG_UNKD);
		}
	} else if (temp_v0 == 0) {
		...
		/* Store movement values to alien type structure */
		AlienType *type = &alienTypes[sp52];
		type->unk20 = (s16)sp3C;
		type->unk28 = (s16)sp40;
		type->unk30 = (s16)sp44;
		...
		if (func_800871CC_9617C(arg0, 0, 0x32) != 0) {
			...
			alien_instance->unk20 = (s32)(temp_a0 | ALIEN_FLAG_UNKE);
			...
			alien_instance->unk20 = (s32)(alien_instance->unk20 ^ ALIEN_FLAG_Z);
		}
	}
		...
		if (flags2 & 0x1000) {
			...
			if (counter != 0) {
				...
				if (alien_ptr->unk2C < 0xF) {
					sp74->unk20 = sp74->unk20 | ALIEN_FLAG_UNKD;
				}
			} else {
				sp48->unk20 = flags2 & ~ALIEN_FLAG_UNKD;
				alien1->unk20 = alien1->unk20 & ~ALIEN_FLAG_UNKD;
				sp74->unk20 = sp74->unk20 & ~ALIEN_FLAG_UNKD;
				node_ptr->unkA = 0;
				alien1->unk20 = alien1->unk20 | ALIEN_FLAG_UNKE;
				node_ptr2->unkA = 0;
				alien1->unk26 = 4;
				alien1->unk36 = 4;
...
void func_802DDE04_1F6B14(u8 arg0) {
	...
	if (!(alien2->unk20 & (ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKF)) && ((alien1->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) != (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) && (alien1->unk1E == 0) && (alien1->unk2C != 0)) {
		if (func_80084FE8_93F98(arg0, 0x800) != 0) {
			alien2->unk20 = (s32) (alien2->unk20 | ALIEN_FLAG_UNKE);
			alien1->unk36 = 0;
		...
		type_id1 = lookup_table->unkC;
		value40 = (s16) type_id1;

		lookup_table = &D_8014DD50[type_id1];
		type_id2 = lookup_table->unkC;
		value42 = (s16) type_id2;

		lookup_table = &D_8014DD50[type_id2];
		type_id3 = lookup_table->unkC;
		value44 = (s16) type_id3;

		lookup_table = &D_8014DD50[type_id3];
		type_id4 = lookup_table->unkC;
		value46 = (s16) type_id4;

		lookup_table = &D_8014DD50[type_id4];
		type_id5 = lookup_table->unkC;
		value48 = (s16) type_id5;

		if (alien2->unk20 & ALIEN_FLAG_UNKE) {
			dmg_threshold = 0x2710;
		} else {
			dmg_threshold = 0;
			if ((alien1->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) == (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) {
		...
		weapon_struct = &D_8014DD50[type_id5];
		weapon_struct->unk8 = (u16) (weapon_struct->unk8 + alien1->unk2C);

		func_80137468_146418(arg0, 0x261);

		if ((alien1->unk2C >= 0x26AD) && ((alien2->unk20 & ALIEN_FLAG_UNKE) != 0)) {
			alien2->unk20 = (s32) (alien2->unk20 | ALIEN_FLAG_UNKD);
			...
			if (weapon_dmg == 2) {
				...
				alien2->unk20 = (s32) (alien2->unk20 & ~(ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD));
			}
		}
	}
}
...
void func_802DE0C8_1F6DD8(u8 arg0) {
	...
	if (!(otherIdx->unk20 & (ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKF)) && ((alienIdx->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) != (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) && (alienIdx->unk1E == 0)) {
		...
		if (var_a1 >= 0x4001) {
			otherIdx->unk20 |= ALIEN_FLAG_UNKF;
			alienIdx->unk36 = 0;
		}
	} else {
		sp88 = alienIdx->unkC;
		...
		if (otherIdx->unk20 & ALIEN_FLAG_UNKF) {
			...
			if (funcResult == 2) {
				...
				alienIdx->unk20 |= ALIEN_FLAG_INVINCIBLE;
				...
				if (funcResult == 3) {
					otherIdx->unk20 &= ~ALIEN_FLAG_UNKD;
					return;
				}
				if (funcResult == 4) {
					otherIdx->unk20 &= ~ALIEN_FLAG_UNKF;
...
void func_802DE594_1F72A4(u8 arg0) {
	...
	if (!(parentAlien->unk20 & ALIEN_FLAG_UNKH)) {
		if (alien->unk12 != 0) {
			sp50 = arg0 & 0xFF;
			arg0 = (u8) (arg0 & 0xFF);
		...
		if (!(parentAlien->unk20 & ALIEN_FLAG_UNKD)) {
			...
			if (((flags & 0xF000) != 0xF000) && (flags & 0x8000) && (distance < 0x7D0)) {
				...
				if (maxDiff >= 0x4001) {
					...
					alien->unk20 = (s32) (alien->unk20 | ALIEN_FLAG_AWAY);
				} else {
		...
		if ((alien->unk20 & (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) == (ALIEN_FLAG_UNKG | ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKE | ALIEN_FLAG_UNKD)) {
			if (D_80031420 & 3) {
			...
			if (!(temp & 0x6000)) {
				parentAlien->unk20 = (s32) (temp | (ALIEN_FLAG_UNKF | ALIEN_FLAG_UNKD));
				alien->unk36 = 0;
				alien->unk20 = (s32) (alien->unk20 & ~ALIEN_FLAG_PLAYER);
		...
		if (alien->unk26 != 0) {
			alien->unk20 = (s32) (alien->unk20 | ALIEN_FLAG_INVINCIBLE);
		} else {
			alien->unk20 = (s32) (alien->unk20 & ~ALIEN_FLAG_INVINCIBLE);
		}
		flags = alien->unk20;
...
void func_802DE9B8_1F76C8(s32 arg0) {
	...
	if ((flags & 0x6000) == 0x6000 && !(grandparentAlien->unk20 & ALIEN_FLAG_UNKD)) {
		if (alien->unk1E != 0) {
			alien->unk1E--;
			return;
		}
...
void func_802DEE4C_1F7B5C(u8 arg0) {
	...
	if (alien->unk20 & ALIEN_FLAG_UNKE) {
		...
		func_80086A34_959E4(arg0, 0, (s16) func_800870D8_96088(0x100, alien->unk26));
		if (alien->unk36 != 0) {
			alien->unk36--;
		} else {
			alien->unk20 &= ~ALIEN_FLAG_UNKE;
	...
	if (alien->unk2C < var_a3) {
		alien->unk2C += 0x190;
	} else if (var_a3 < alien->unk2C) {
		alien->unk2C -= 0x190;
	}
}
#else
...
/* Copies template type data into an alien's type entry and initializes its instance fields */
void func_802DF8DC_1F85EC(u8 arg0, s32 arg1) {
	...
	type = &alienTypes[typeIndex];
	*type = D_802E0CE4_1F99F4;
	inst->unk20 = 0x8004500;
	inst->hitPoints = type->unk3A;
	type->unk0 = arg1;
...
void func_802DF99C_1F86AC(u8 arg0) {
	...
	if (flags & ALIEN_FLAG_FALL) {
		...
		AlienType *type = &alienTypes[typeIndex];

		type->unk54 |= 4;

		if (parent->unk24 != 0) {
			if (parent->unk2C == 0xA0) {
				inst->unk20 |= (ALIEN_FLAG_PLAYER | ALIEN_FLAG_AWAY);
