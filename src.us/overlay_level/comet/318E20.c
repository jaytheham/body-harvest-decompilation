...
void func_802D7B4C_31BC9C(u8 arg0) {
    ...
    if ((func_802D4CD0_318E20((s32)D_80052B34, (void *)inst) < 0x1388) &&
        (func_802D4CD0_318E20((s32)arg0, (void *)0x8000) != 0)) {
        if (func_802D4CD0_318E20((s32)arg0, (void *)0, (void *)0x14) != 0) {
            inst->unk3D = (s8)(inst->unk3D + 1);
            if (inst->unk3D == 3) {
                inst->unk1E = 0x46;
                inst->unk3D = 0;
            } else {
        ...
        func_802D4CD0_318E20((s32)arg0, (void *)NULL);
    }
    temp_v0 = inst->unk1E;
    if (temp_v0 != 0) {
        inst->unk1E = (s16)(temp_v0 - 1);
    }
}
...
s32 func_802E1274_3253C4(u8 arg0) {
    AlienInstance *inst;
    u8 idx;
    u8 idx2;
...
s32 func_802E193C_325A8C(u8 arg0) {
    AlienInstance *inst;
    u8 idx;
    u8 idx2;
...
void func_802E21C4_326314(s32 arg0) {
    ...
    temp_s0 = arg0 & 0xFF;
    sp2C = (s16)*(&D_8014DD5C + func_802DFF04_324054(temp_s0 & 0xFF));
    func_802E205C_3261AC(temp_s0 & 0xFF);
    temp_v0 = func_800870D8_96088(0x80, 0x20);
    temp_v1 = (sp2C * 0x10) + &D_8014DD50;
    sp24 = temp_v1;
    if (func_80086D70_95D20(temp_s0 & 0xFF, 0, (s16)(temp_v0 - temp_v1->unk6)) != 0) {
        *(&D_800481B6 + (temp_s0 * 0x50)) = 0;
        func_80086D70_95D20(temp_s0 & 0xFF, 1, (s16)(func_800870D8_96088(0x80, 0x20) - sp24->unk6));
