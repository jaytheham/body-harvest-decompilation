...
#pragma GLOBAL_ASM("asm/nonmatchings/overlay_level/siberia/2B7100/func_802D7540_2B9970.s")
...
void func_802DACA0_2BD0D0(u8 arg0) {
    ...
    temp_v0 = D_80222A70 - 0x28;
    if (temp_v0 < instance->unk2) {
        instance->unk2 = temp_v0;
    }
...
void func_802DB390_2BD7C0(u8 arg0) {
    ...
    instance = &alienInstances[arg0];
    flags = instance->unk20;
    value = instance->unkE;
    instance->unk20 = flags & ~0x10;
    instance->unk6 = value;
}
#else
