...
void func_80011E14_12A14(u8 arg0) {
	...
	gSPSegment(D_8005BB2C++, 1, K0_TO_PHYS(__printfunc));
	gSPSegment(D_8005BB2C++, 5, K0_TO_PHYS(D_8006AA6C));
	gSPSegment(D_8005BB2C++, 0xF, K0_TO_PHYS(D_8006AA74));
	gSPSegment(D_8005BB2C++, D_80031C68_32868[arg0], K0_TO_PHYS(D_8006AA70));
	if (D_80052ACA == 2 && currentLevel != LEVEL_COMET) {
		gSPSegment(D_8005BB2C++, D_80031C68_32868[6], K0_TO_PHYS(D_8006AA70));
	}
	func_80004C8C_588C();
}
